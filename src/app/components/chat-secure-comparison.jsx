import { Card, CardContent, Box, Typography, Grid, Chip, Table, TableBody, TableCell, TableHead, TableRow } from "@mui/material";
import { AccessTime, Email, Forum, CheckCircle, Cancel, ArrowForward, Bolt, Group, Description, Smartphone, Search, Security } from "@mui/icons-material";
              ...
              <Grid item xs={12} md={6} lg={3} key={index}>
                ...
                >
                  <CardContent sx={{ p: 3 }}>
                    ...
                    <Typography
                      variant="h6"
                      sx={{ fontWeight: 700, color: "#fff", mb: 1, textAlign: "center" }}
                    >
                      {metric.title}
                    </Typography>
                ...
                <Box sx={{ mb: 4, display: "flex", flexDirection: "column", gap: 1 }}>
                  {beforeAfterData.before.challenges.map((challenge, index) => (
                    <Box key={index} sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                      ...
                      <Typography sx={{ color: "#fee2e2", fontSize: "0.875rem" }}>
                        {challenge}
                      </Typography>
                    </Box>
                  ))}
                ...
                <Box sx={{ mb: 4, display: "flex", flexDirection: "column", gap: 1 }}>
                  {beforeAfterData.after.capabilities.map((capability, index) => (
                    <Box key={index} sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                      ...
                      <Typography sx={{ color: "#dcfce7", fontSize: "0.875rem" }}>
                        {capability}
                      </Typography>
                    </Box>
                  ))}
            ...
            <CardContent sx={{ p: 0 }}>
              <Box sx={{ overflowX: "auto" }}>
                <Table>
                  <TableHead>
                    <TableRow
                      sx={{ background: "linear-gradient(to right, #7c3aed, #ec4899)" }}
                    >
                      <TableCell sx={{ color: "#fff", fontWeight: 700, p: 2, textAlign: "left" }}>
                        Feature
                      </TableCell>
