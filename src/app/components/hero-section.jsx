  ...
  return (
    ...
    >
      ...
      <Container maxWidth={false} sx={{ position: "relative", height: "100%" }}>
        ...
        >
          <Grid container spacing={{ xs: 2, sm: 2, md: 4, lg: 4 }} alignItems="center" justifyContent={"center"} sx={{ width: "100%" }}>
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: { xs: 2, sm: 3 } }}>
                  ...
                  >
                    Transform your team communication with intelligent automation. Communication - Chat Pro streamlines
                    collaboration from messaging to file sharing, working around the clock to enhance your productivity.
                  </Typography>
                </Box>
